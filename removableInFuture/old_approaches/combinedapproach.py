...
def separate_percussive_and_harmonic(audio_path, percussive_output, harmonic_output):
    ...
    threshold_max = 0.8  # Maximum amplitude threshold
    start_time = 0.0  # Time (in seconds) of the first drum hit
    target_frequency_min = 230  # Lower bound of target frequency
    target_frequency_max = 950  # Upper bound of target frequency
...
percussive_output_filename = 'extracted_percussive_guitar.wav'
